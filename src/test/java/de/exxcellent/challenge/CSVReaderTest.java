...
public class CSVReaderTest {
	...
	@Test
	public void simpleCSVFileShouldBeParsedAsEmptyArrayList() {
		URL url = getClass().getResource(EMPTY_CSV_FILE);
		ArrayList dataArray = CSVReader.parseIntoArrayList(url.getPath());
	...
	public void simpleCSVFileShouldBeParsed() {
		...
		Assert.assertEquals("2", dataArray.get(0).get(HEADER_1));
		Assert.assertEquals("3", dataArray.get(1).get(HEADER_2));
